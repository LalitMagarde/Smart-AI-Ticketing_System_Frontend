...
import { asyncUpdateUser } from '../../store/action/userActions';
...
const UserManagementModal = ({ user, onClose, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = { email: user.email, role: role, skills: skillsArray }

      const updatedUser = await dispatch(asyncUpdateUser(data));
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  {['Admin', 'User', 'Manager'].map((r) => (  // Replace with your actual roles
